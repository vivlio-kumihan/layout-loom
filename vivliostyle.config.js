module.exports = {
  title: 'css_syntax', // populated into `manifest.json`, default to `title` of the first entry or `name` in `package.json`.
  author: '高広信之 <takahiro@kumihan.com>', // default to `author` in `package.json` or undefined.
